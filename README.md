...
This project was developed with AI agent assistance (Trae AI), following the "vibe coding" approach where the developer focuses on high-level design and problem-solving while AI handles implementation details.
